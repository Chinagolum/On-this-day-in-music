#!/bin/bash
# ============================================================
#  build_lambdas.sh — Build, deploy, and force-update all Lambdas
# ============================================================
set -e
...
echo ""
echo "🚀 Deploying to AWS (force-updating all Lambdas)..."
cd terraform
terraform apply -auto-approve \
  -replace=aws_lambda_function.schedule_tweets \
  -replace=aws_lambda_function.twitter_bot \
  -replace=aws_lambda_layer_version.dependencies
echo "✅ Deployed!"